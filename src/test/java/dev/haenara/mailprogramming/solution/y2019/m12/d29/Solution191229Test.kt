...
internal class Solution191229Test {
    ...
    @Test
    fun `191229-TC4 0이 없을 때 정상적으로 정렬된 결과`() {
        assertArrayEquals(
            arrayOf(1, 2, 3, 4, 5),
    ...
    @Test
    fun `191229-TC5 0이 1개만 있을 때 정상적으로 정렬된 결과`() {
        assertArrayEquals(
            arrayOf(1, 2, 3, 4, 5, 0),
    ...
    @Test
    fun `191229-TC7 0이 앞에 몰려있을 때 정상적으로 정렬된 결과`() {
        assertArrayEquals(
            arrayOf(0, 0, 0, 6, 8, 2, 3, 4, 1),
            Solution191229().solution(arrayOf(6, 8, 2, 3, 4, 1, 0, 0, 0))
        )
    }
    ...
    fun `191229-TC8 0이 중간중간 있어도 정상적으로 정렬된 결과`() {
        assertArrayEquals(
            arrayOf(0, 6, 0, 8, 0, 2, 0, 3, 0, 4, 0, 1, 0),
            Solution191229().solution(arrayOf(6, 8, 2, 3, 4, 1, 0, 0, 0, 0, 0, 0, 0))
        )
    }
}